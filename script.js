...
pegarPersonagem = () => {
    let numeroAletorio1 = gerarValorAletorio();
    let numeroAletorio2 = gerarValorAletorio();
    let numeroAletorio3 = gerarValorAletorio();

    fetch(`https://rickandmortyapi.com/api/character/${numeroAletorio1}`, {
        method: 'GET',
        headers: {
    ...
    fetch(`https://rickandmortyapi.com/api/character/${numeroAletorio2}`, {
        method: 'GET',
        headers: {
            Accept: 'application/jason',
            "Content-type": 'application/jason'
    ...
    return fetch(`https://rickandmortyapi.com/api/character/${numeroAletorio3}`, {
        method: 'GET',
        headers: {
            Accept: 'application/jason',
            "Content-type": 'application/jason'
